...
var _FormErrors = __webpack_require__(30);
...
var Home = function (_React$Component) {
    ...
    _createClass(Home, [{
        key: 'onInputUpdate',
        value: function onInputUpdate(event) {
            event.preventDefault();
        ...
        value: function validateField(fieldname, value) {
            var currFormErrors = void 0,
                updatedFormErrors = void 0;
            //save current errors
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_FormErrors2.default, {
                    errors: formErrors,
...
var TodoForm = function TodoForm(_ref) {
  var onInputUpdate = _ref.onInputUpdate,
      value = _ref.value,
...
var FormErrors = function FormErrors(_ref) {
    ...
    return _react2.default.createElement(
        ...
        Object.keys(errors).map(function (fieldName, i) {
            if (errors[fieldName] !== '') {
                return _react2.default.createElement(
                    'div',
                    { className: 'errors-section', key: i },
                    _react2.default.createElement(
                        'p',
                        null,
                        ' ',
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'clear-error', onClick: function onClick() {
                                return clear();
                            } },
                        ' \u2A2F '
                    )
        ...
        todos.map(function (item, i) {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    null,
                    ' ',
                    _react2.default.createElement('input', { type: 'checkbox', name: 'todi-item', value: item }),
                    '  ',
                    item
                )
            );
